...
namespace WebAppTransporte.Controllers
{
    ...
    public class CarroceriasXTiposDeVehiculosXOfertasController : ControllerBase
    {
        ...
        public async Task<IActionResult> ConsultarXOferta(long idOferta)
        {
            ...
            return Ok(await _carroceriasXTiposDeVehiculosXOfertasServicios.ConsultarXOferta(idOferta));
        }
        ...
        {
            await _carroceriasXTiposDeVehiculosXOfertasServicios.BorrarPorIdOferta(idOferta);
            return Ok();
        }
