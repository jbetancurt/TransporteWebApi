...
namespace WebAppTransporte.Controllers
{
    ...
    public class Plantillas_CarroceriasXTiposDeVehiculosXOfertasController : ControllerBase
    {
        ...
        public async Task<IActionResult> ConsultarXOferta(long idOferta)
        {
            ...
            return Ok(await _plantillas_CarroceriasXTiposDeVehiculosXOfertasServicios.ConsultarXOferta(idOferta));
        }
        ...
        {
            await _plantillas_CarroceriasXTiposDeVehiculosXOfertasServicios.BorrarPorIdOferta(idOferta);
            return Ok();
        }
